#!/bin/sh
# Checks upstream syncthing for a new release and fires OS5 alert 1501 if found.
# Added to root crontab by install.sh; removed by remove.sh.
# Can also be run manually: sh /path/to/syncthing/check_update.sh

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
APP_NAME="syncthing"
UPSTREAM_API="https://api.github.com/repos/syncthing/syncthing/releases/latest"
