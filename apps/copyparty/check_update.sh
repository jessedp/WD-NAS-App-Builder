#!/bin/sh
# Checks upstream copyparty for a new release and fires OS5 alert 1501 if found.
# Added to root crontab by install.sh; removed by remove.sh.
# Can also be run manually: sh /path/to/copyparty/check_update.sh

SCRIPT_DIR="$(cd "$(dirname "$0")" && pwd)"
APP_NAME="copyparty"
UPSTREAM_API="https://api.github.com/repos/9001/copyparty/releases/latest"
